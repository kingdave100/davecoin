...
uint256 hashGenesisBlock("0x2705dd96dfea6255f5f7ea1834d21fe26362ea89522676c05180eb4a70011254");
...
const string strMessageMagic = "DaveCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // DaveCoin: 1 days
static const int64 nTargetSpacing = 10; // DaveCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal davecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DaveCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x22b06d36226ee8f00402ef7b83ab5c553c5794ff2a5f40142ee2daf1b62158b7");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1385241349; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 524147;

        if (fTestNet)
        {
            block.nTime    = 1385088986;
            block.nNonce   = 3033894;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc805fb0ba870a1bb4927186666a60b1e89bfbb1c0bf8ea2b16f257b796ff96fb"));
